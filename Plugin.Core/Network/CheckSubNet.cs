...
namespace Plugin.Core.Network
{
    public static class CheckSubNet
    {
        ...
        public static bool checkInSubNet(this IPAddress _host, IPAddress _addr, IPAddress _mask)
        {
            ...
            {
                CLogger.Print("[Core.CheckSubNet.checkInSubNet] \n\r" + e, Plugin.Core.Enums.LoggerType.Error, e);
            }
            return false;
        }
        ...
        private static IPAddress CidrToMask(byte mask = 24)
        {
            ...
            {
                CLogger.Print("[Core.CheckSubNet.CidrToMask] \n\r" + ex, Plugin.Core.Enums.LoggerType.Error, ex);
